...
TEST_F(UDoubleEnsembleTest, PlusEquals)
{
  ...
  EXPECT_FLOAT_EQ(ud.deviation(), 1.1530961);
}
...
TEST_F(UDoubleEnsembleTest, PlusEqualsLarge)
{
  ...
  ud += ud2;
  EXPECT_FLOAT_EQ(ud.mean(), 5.0);
  EXPECT_FLOAT_EQ(ud.deviation(), 5.1418414);
}
...
TEST_F(UDoubleEnsembleTest, MinusEquals)
{
  ...
  ud -= ud2;
  EXPECT_FLOAT_EQ(ud.mean(), 2.0);
  EXPECT_FLOAT_EQ(ud.deviation(), 1.1260865);
}
...
TEST_F(UDoubleEnsembleTest, MinusEqualsLarge)
{
  ...
  EXPECT_FLOAT_EQ(ud.deviation(), 5.1139555);
}
...
TEST_F(UDoubleEnsembleTest, DivEquals)
{
  ...
  EXPECT_FLOAT_EQ(ud.mean(), 2.3744812);
  EXPECT_FLOAT_EQ(ud.deviation(), 7.9007583);
}
...
TEST_F(UDoubleEnsembleTest, DivEqualsReciprocal)
{
  ...
  ud /= uncertain::EnsembleSmall(2.0, 1.0);
  EXPECT_FLOAT_EQ(ud.mean(), 0.63049471);
  EXPECT_FLOAT_EQ(ud.deviation(), 1.8518502);
}
...
TEST_F(UDoubleEnsembleTest, DivEqualsLarge)
{
  ...
  EXPECT_FLOAT_EQ(ud.mean(), 12.625203);
  EXPECT_FLOAT_EQ(ud.deviation(), 272.90494);
}
...
TEST_F(UDoubleEnsembleTest, DivEqualsLargeReciprocal)
{
  ...
  ud /= uncertain::EnsembleLarge(2.0, 2.0);
  EXPECT_FLOAT_EQ(ud.mean(), 0.81952477);
  EXPECT_FLOAT_EQ(ud.deviation(), 18.990055);
}
...
TEST_F(UDoubleEnsembleTest, TimesEqualsLarge)
{
  ...
  ud2 /= ud;
  EXPECT_FLOAT_EQ(ud2.mean(), 7.330265);
  EXPECT_FLOAT_EQ(ud2.deviation(), 15.943852);
...
TEST_F(UDoubleEnsembleTest, Ceiling)
{
  ...
  EXPECT_FLOAT_EQ(ud2.deviation(), 1.0364453);
}
...
TEST_F(UDoubleEnsembleTest, SqrtSmall)
{
  ...
  auto ud2 = sqrt(ud);
  EXPECT_FLOAT_EQ(ud2.mean(), 7.9997559);
  EXPECT_FLOAT_EQ(ud2.deviation(), 0.062506683);
}
...
TEST_F(UDoubleEnsembleTest, SqrtLarge)
{
  ...
  auto ud2 = sqrt(ud);
  EXPECT_FLOAT_EQ(ud2.mean(), 7.9990225);
  EXPECT_FLOAT_EQ(ud2.deviation(), 0.12505354);
}
...
TEST_F(UDoubleEnsembleTest, PowSmall)
{
  ...
  auto ud3 = pow(ud, ud2);
  EXPECT_FLOAT_EQ(ud3.mean(), 66.276054);
  EXPECT_FLOAT_EQ(ud3.deviation(), 21.70063);
}
...
TEST_F(UDoubleEnsembleTest, PowLarge)
{
  ...
  auto ud3 = pow(ud, ud2);
  EXPECT_FLOAT_EQ(ud3.mean(), 66.119255);
  EXPECT_FLOAT_EQ(ud3.deviation(), 21.194429);
}
